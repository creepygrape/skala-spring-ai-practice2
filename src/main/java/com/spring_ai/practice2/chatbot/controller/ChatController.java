...
import com.spring_ai.practice2.chatbot.security.AnonymousVisitorFilter;
...
public class ChatController {
    ...
    public Flux<ServerSentEvent<String>> streamChat(
            @RequestAttribute(AnonymousVisitorFilter.VISITOR_ID_ATTRIBUTE) String visitorId,
            @RequestBody ChatRequest request) {
        quotaService.checkAndDecrease(visitorId);
        return chatService
                .streamChat(visitorId, request.sessionId(),
                        request.message())
